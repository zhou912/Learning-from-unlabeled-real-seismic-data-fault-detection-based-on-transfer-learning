...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep  6 16:04:35 2019
...
conv2 = Conv3D(32, (3, 3, 3), activat64ion='relu', padding='same')(conv2)
...
#    print (i,'epouch_num')
    if train_mode == 'dann':
        ...
        #save class_weight and train domain_dann t200010o get common feature
        class_weights = []
    ...
    if train_mode == 'class':
        ...
        cost = source_classuntitled2ification_model.train_on_batch(X_adv,y_class,sample_weight=sample_weights_class)
